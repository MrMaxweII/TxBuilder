...
/*******************************************************************************************************************************************
*		V1.6	   												 Autor: Mr. Maxwell  									vom 10.03.2024		*
*																																			*
*		Letzte Änderung: Font für TextFelder geändert in "Ubuntu Mono".																		*
*		BTClib3001	Klasse																													*
 ...
 * @wbp.parser.constructor**/
	public TxPrinter(byte[] magic, Transaktion tx, int x, int y) 
	{
		...
		Font			font4			= new Font("Ubuntu Mono", Font.PLAIN, 14); 		// Font für Textfelder
