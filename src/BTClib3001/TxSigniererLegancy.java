...
*																																			*
*		Letzte Änderung: sigTx1() wurde entfernt! Nicht Notwendig, Witness wurde entfernt! Jetzt in TxSigniererWitness!						*
*		Letzte Änderung: in Methode sigTx(); Hash-Code "01000000" hinzugefügt. (Der HashCode wird nun erst beim Signieren hinzugefügt!		*
*		Letzte Änderung: Methode calcPrivKeyList(); hinzugefügt																				*
*		BTClib3001	Klasse																													*
*		Dieser Transaktions-Singnierer signiert unsignierte Legancy Transaktionen.  														*
*		static Klasse ohne Konstruktor																										*
*		Klasse getestet! Funktioniert für alle Legancy-Transaktionen (mit mehreren Inputs oder Outputs) fehlerfrei ab Version V1.2.0!		*
********************************************************************************************************************************************/
...
Funktioniert auch NICHT für Legancy-Inputs die im Witness-Transaktionen eingebettet sind!  **/
