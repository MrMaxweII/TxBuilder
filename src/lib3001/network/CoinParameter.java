...
public static CoinParameter getFromSymbol(String symbol)
{
	...
	for (CoinParameter element : coinParameter) {
		if(symbol.equals(element.symbol))return element;
	}
...
public static CoinParameter getFromName(String name)
{
	...
	for (CoinParameter element : coinParameter) {
		if(name.equals(element.name))    return element;
	}
...
public static CoinParameter getFromMagic(byte[] magic)
{
	...
	for (CoinParameter element : coinParameter) {
		if(Arrays.equals(element.magic, magic))    return element;
	}
   return null;
}
...
public static CoinParameter getFromGenesisBlock(byte[] genesisBlockHash)
{
	...
	for (CoinParameter element : coinParameter) {
		if(Arrays.equals(element.genesisBlockHash, genesisBlockHash))    return element;
	}
	return null;
}
